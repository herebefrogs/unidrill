// SoundBox "player-small" (Marcus Geelnard, 2011-2013), zlib/libpng licensed —
// the playback routine for songs exported from the voxby tracker. Trimmed to
// what the game uses: init / generate / createAudioBuffer (createWave and
// getData dropped). See sound.js for the render+play wrapper.
...
export const CPlayer = function() {
    ...
    // Generate audio data for a single track. Returns progress (1.0 == done).
    ...
    // Create an AudioBuffer from the generated audio data.
